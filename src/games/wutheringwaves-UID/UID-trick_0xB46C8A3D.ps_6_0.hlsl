...
float4 main(
  ...
  if (SV_Position.x >= 3336.0f && SV_Position.y >= 2116.0f)
  {
    discard;
  }
  
  float _43 = (View_704[0].x) * SV_Position.x;
  float _44 = mad(SV_Position.y, (View_704[1].x), _43);
  float _45 = mad(SV_Position.z, (View_704[2].x), _44);
  float _46 = _45 + (View_704[3].x);
  float _47 = (View_704[0].y) * SV_Position.x;
  float _48 = mad(SV_Position.y, (View_704[1].y), _47);
  float _49 = mad(SV_Position.z, (View_704[2].y), _48);
  float _50 = _49 + (View_704[3].y);
  float _51 = (View_704[0].z) * SV_Position.x;
  float _52 = mad(SV_Position.y, (View_704[1].z), _51);
  float _53 = mad(SV_Position.z, (View_704[2].z), _52);
  float _54 = _53 + (View_704[3].z);
  float _55 = (View_704[0].w) * SV_Position.x;
  float _56 = mad(SV_Position.y, (View_704[1].w), _55);
  float _57 = mad(SV_Position.z, (View_704[2].w), _56);
  float _58 = _57 + (View_704[3].w);
  float _59 = _46 / _58;
  float _60 = _50 / _58;
  float _61 = _54 / _58;
  float _62 = _59 - View_1120.x;
  float _63 = _60 - View_1120.y;
  float _64 = _61 - View_1120.z;
  bool _67 = ((Material_032[0].x) < 0.5f);
  float _73;
  float _74;
  float _75;
  float _126;
  ...
  float _189;
  if (_67) {
    float _69 = COLOR.x * COLOR.x;
    float _70 = COLOR.y * COLOR.y;
    float _71 = COLOR.z * COLOR.z;
    _73 = _69;
    _74 = _70;
    _75 = _71;
  } else {
  ...
  float _87 = TEXCOORD.z + -1.0f;
  float _88 = TEXCOORD.w + -1.0f;
  float4 _91 = t1.SampleBias(s1, float2(_87, _88), View_2388, int2(0, 0));
  float _96 = _91.x * _86;
  float _97 = _91.y * _86;
  float _98 = _91.z * _86;
  float _99 = _91.w * _86;
  bool _102 = ((Material_032[0].x) > 0.5f);
  if (_102) {
    ...
    float _110 = _107 * 0.4166666567325592f;
    float _111 = _108 * 0.4166666567325592f;
    float _112 = _109 * 0.4166666567325592f;
    float _113 = exp2(_110);
    float _114 = exp2(_111);
    float _115 = exp2(_112);
    float _116 = _113 * 1.0549999475479126f;
    float _117 = _114 * 1.0549999475479126f;
    float _118 = _115 * 1.0549999475479126f;
    float _119 = _116 + -0.054999999701976776f;
    float _120 = _117 + -0.054999999701976776f;
    float _121 = _118 + -0.054999999701976776f;
    float _122 = max(_119, 0.0f);
    float _123 = max(_120, 0.0f);
    float _124 = max(_121, 0.0f);
    _126 = _122;
    _127 = _123;
    _128 = _124;
  } else {
  ...
  float _130 = _127 + _84;
  float _131 = _128 + _85;
  float _137 = (Material_000[1].x) - _129;
  float _138 = (Material_000[1].y) - _130;
  float _139 = (Material_000[1].z) - _131;
  float _140 = _137 * (Material_032[0].y);
  float _141 = _138 * (Material_032[0].y);
  float _142 = _139 * (Material_032[0].y);
  float _143 = _140 + _129;
  float _144 = _141 + _130;
  float _145 = _142 + _131;
  float _146 = _99 + _81;
  float _147 = _146 * COLOR.w;
  float _148 = saturate(_147);
  float _149 = max(_143, 0.0f);
  float _150 = max(_144, 0.0f);
  float _151 = max(_145, 0.0f);
  bool _154 = (View_2336 > 0.0f);
  [branch]
  if (_154) {
    float _160 = _62 - Primitive_080.x;
    float _161 = _63 - Primitive_080.y;
    float _162 = _64 - Primitive_080.z;
    float _163 = abs(_160);
    float _164 = abs(_161);
    float _165 = abs(_162);
    float _170 = Primitive_304.x + 1.0f;
    float _171 = Primitive_304.y + 1.0f;
    float _172 = Primitive_304.z + 1.0f;
    bool _173 = (_163 > _170);
    bool _174 = (_164 > _171);
    bool _175 = (_165 > _172);
    bool _176 = _173 || _174;
    bool _177 = _175 || _176;
    if (_177) {
      float _179 = dot(float3(_62, _63, _64), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f));
      float _180 = _179 * 0.0020000000949949026f;
      float _181 = frac(_180);
      bool _182 = (_181 > 0.5f);
      float _183 = float((bool)_182);
  ...
  float _190 = -0.0f - _187;
  float _191 = -0.0f - _188;
  float _192 = -0.0f - _189;
  float _193 = min(_190, 0.0f);
  float _194 = min(_191, 0.0f);
  float _195 = min(_192, 0.0f);
  float _196 = -0.0f - _193;
  float _197 = -0.0f - _194;
  float _198 = -0.0f - _195;
  SV_Target.x = _196;
  SV_Target.y = _197;
  SV_Target.z = _198;
  SV_Target.w = _186;
