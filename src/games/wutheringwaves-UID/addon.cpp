...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0xB46C8A3D), // Hide UID - YOUR TARGET SHADER
};
...
extern "C" __declspec(dllexport) constexpr const char* NAME = "RenoDX - WuWa Hide UID";
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX (Wuthering Waves - Hide UID)";
